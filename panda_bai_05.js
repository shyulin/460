...
//        const dtp2 = obj.route.deliveries[1].distance_to_pickup ;
        ...
        const si2 = obj.route.addresses[4].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[4].special_instructions ;
...
//        const dtp3 = obj.route.deliveries[2].distance_to_pickup ;
        ...
        const si3 = obj.route.addresses[5].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[5].special_instructions ;
...
//        const dtp1 = obj.route.deliveries[0].distance_to_pickup ;
        ...
        const si1 = obj.route.addresses[4].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[4].special_instructions ;
...
//        const dtp2 = obj.route.deliveries[1].distance_to_pickup ;
        ...
        const si2 = obj.route.addresses[5].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[5].special_instructions ;
...
//        const dtp3 = obj.route.deliveries[2].distance_to_pickup ;
        ...
        const si3 = obj.route.addresses[6].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[6].special_instructions ;
 ...
 //       const dtp4 = obj.route.deliveries[3].distance_to_pickup ;
        ...
        const si4 = obj.route.addresses[7].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[7].special_instructions ;
...
//        const dtp1 = obj.route.deliveries[0].distance_to_pickup ;
        ...
        const si1 = obj.route.addresses[5].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[5].special_instructions ;
...
//        const dtp2 = obj.route.deliveries[1].distance_to_pickup ;
        ...
        const si2 = obj.route.addresses[6].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[6].special_instructions ;
...
//        const dtp3 = obj.route.deliveries[2].distance_to_pickup ;
        ...
        const si3 = obj.route.addresses[7].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[7].special_instructions ;
...
//        const dtp4 = obj.route.deliveries[3].distance_to_pickup ;
        ...
        const si4 = obj.route.addresses[8].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[8].special_instructions ;
...
//        const dtp5 = obj.route.deliveries[4].distance_to_pickup ;
        ...
        const si5 = obj.route.addresses[9].special_instructions === null ? '！仙女白白降駕，妖魔鬼怪速退！' : obj.route.addresses[9].special_instructions ;
